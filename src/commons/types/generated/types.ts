...
export type ILoginUserMutation = { __typename?: 'Mutation', loginUser: { __typename?: 'Token', accessToken: string } };
...
export const LoginUserDocument = gql`
  ...
  loginUser(email: $email, password: $password) {
    ...
    `;
export type ILoginUserMutationFn = Apollo.MutationFunction<ILoginUserMutation, ILoginUserMutationVariables>;
 ...
 * });
 */
export function useLoginUserMutation(baseOptions?: Apollo.MutationHookOptions<ILoginUserMutation, ILoginUserMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ILoginUserMutation, ILoginUserMutationVariables>(LoginUserDocument, options);
      }
export type LoginUserMutationHookResult = ReturnType<typeof useLoginUserMutation>;
export type LoginUserMutationResult = Apollo.MutationResult<ILoginUserMutation>;
export type LoginUserMutationOptions = Apollo.BaseMutationOptions<ILoginUserMutation, ILoginUserMutationVariables>;